...
(function() {
    ...
    let doctorsList = [
        { id: 1, namaDokter: 'dr. Hendra Wijaya, Sp.PD', spesialisasi: 'Spesialis Penyakit Dalam', poli: 'Poli Umum / Dalam' },
        { id: 2, namaDokter: 'dr. Anisa Rahmawati, Sp.A', spesialisasi: 'Spesialis Anak (Pediatri)', poli: 'Poli Anak' },
        { id: 3, namaDokter: 'dr. Budi Santoso, Sp.THT', spesialisasi: 'Spesialis THT-KL', poli: 'Poli THT' },
        { id: 4, namaDokter: 'dr. Citra Kirana, Sp.KK', spesialisasi: 'Spesialis Kulit & Kelamin', poli: 'Poli Kulit' },
        { id: 5, namaDokter: 'dr. Dian Sastro, Sp.OG', spesialisasi: 'Spesialis Kebidanan & Kandungan', poli: 'Poli Kandungan' }
    ];
    ...
    function populateDoctorSelect() {
        ...
        sel.innerHTML = doctorsList.map(d => `
            <option value="${d.id}">${d.namaDokter} (${d.spesialisasi || 'Dokter Spesialis'})</option>
        `).join('');
                ...
                <div class="p-4 bg-gradient-to-r from-brand-900 via-brand-800 to-emerald-950 text-white flex flex-col gap-3 shrink-0 shadow-md">
                    ...
                    <div class="pt-1">
                        ...
                        <select id="chat-doctor-select" onchange="window.onDoctorChatChanged(this.value)" class="w-full bg-slate-900/80 border border-white/20 rounded-xl py-2 px-3 font-bold text-white text-xs focus:outline-none focus:border-emerald-400 cursor-pointer">
                            <option value="1" class="text-slate-900">dr. Hendra Wijaya, Sp.PD (Spesialis Penyakit Dalam)</option>
                            <option value="2" class="text-slate-900">dr. Anisa Rahmawati, Sp.A (Spesialis Anak)</option>
                            <option value="3" class="text-slate-900">dr. Budi Santoso, Sp.THT (Spesialis THT)</option>
                            <option value="4" class="text-slate-900">dr. Citra Kirana, Sp.KK (Spesialis Kulit)</option>
                            <option value="5" class="text-slate-900">dr. Dian Sastro, Sp.OG (Spesialis Kandungan)</option>
                        </select>
                    </div>
                </div>
